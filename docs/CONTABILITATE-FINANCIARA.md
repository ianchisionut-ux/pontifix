...
Acest release livreaza nucleul contabil, registrele principale si integrarea facturare-incasare. Nu trebuie prezentat drept inlocuitor complet SAGA pana la implementarea si validarea de catre un expert contabil a urmatoarelor module: jurnal de cumparari cu note automate, stocuri si descarcare de gestiune, mijloace fixe si amortizare, salarii, registru-inventar, inchidere anuala, situatii financiare, import extrase bancare, D406 SAF-T complet, declaratii suplimentare si audit trail nerepudiabil. Regulile fiscale si cotele trebuie revizuite la fiecare schimbare legislativa.
