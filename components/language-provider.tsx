...
const translations: Record<'hu' | 'en', Record<string, string>> = {
  hu: {
    ...
    'Parolă': 'Jelszó', 'Intră în portal': 'Belépés a portálra', 'Se conectează...': 'Bejelentkezés...', 'Am uitat parola': 'Elfelejtettem a jelszót', 'Înapoi la site': 'Vissza a weboldalra', 'Ține-mă autentificat pe acest dispozitiv': 'Maradjak bejelentkezve ezen az eszközön',
