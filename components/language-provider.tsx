...
const translations: Record<'hu' | 'en', Record<string, string>> = {
  hu: {
    ...
    'Parolă': 'Jelszó', 'Intră în portal': 'Belépés a portálra', 'Se conectează...': 'Bejelentkezés...', 'Am uitat parola': 'Elfelejtettem a jelszót', 'Înapoi la site': 'Vissza a weboldalra', 'Ține-mă autentificat pe acest dispozitiv': 'Maradjak bejelentkezve ezen az eszközön', 'Deschide camera': 'Kamera megnyitása', 'Închide camera': 'Kamera bezárása', 'Așază cartea de identitate în chenar': 'Helyezze a személyi igazolványt a keretbe', 'Fotografiază și citește': 'Fényképezés és beolvasás',
    'Prezentare': 'Áttekintés', 'Pontaje': 'Munkaidő', 'Angajați': 'Alkalmazottak', 'Salarizare': 'Bérszámfejtés', 'Concedii': 'Szabadságok', 'Rapoarte': 'Jelentések', 'Oferte': 'Ajánlatok', 'Proiecte': 'Projektek', 'Branșamente': 'Csatlakozások', 'Formulare': 'Űrlapok', 'Mesaje': 'Üzenetek', 'Chat intern': 'Belső chat', 'Configurare': 'Beállítások', 'Contabilitate': 'Könyvelés', 'Cont': 'Fiók',
    'Documente tipizate': 'Szabványosított dokumentumok', 'Formulare și cereri': 'Űrlapok és kérelmek', 'Previzualizare, printare și gestiunea modelelor companiei.': 'A vállalati sablonok előnézete, nyomtatása és kezelése.', 'Adaugă formular': 'Űrlap hozzáadása', 'Semnare documente': 'Dokumentumok aláírása', 'Adaugă șablon de semnare': 'Aláírási sablon hozzáadása', 'Deschide editorul': 'Szerkesztő megnyitása', 'Vizualizează': 'Megtekintés', 'PDF original': 'Eredeti PDF', 'Cereri': 'Kérelmek', 'Modelele de cereri urmează să fie configurate': 'A kérelemsablonok konfigurálása következik', 'Pentru fiecare cerere vom stabili ce date se preiau din proiectul sau branșamentul selectat.': 'Minden kérelemnél meghatározzuk, hogy mely adatok kerüljenek át a kiválasztott projektből vagy csatlakozásból.', 'Printează': 'Nyomtatás', 'Deschide PDF': 'PDF megnyitása', 'Înlocuiește': 'Csere', 'Încarcă un model PDF tipizat.': 'Töltsön fel egy szabványos PDF-sablont.', 'Denumirea formularului': 'Az űrlap neve', 'Selectează documentul PDF': 'Válassza ki a PDF dokumentumot', 'Maximum 20 MB': 'Legfeljebb 20 MB', 'Renunță': 'Mégse', 'Fișierul trebuie să fie PDF.': 'A fájlnak PDF formátumúnak kell lennie.', 'PDF-ul poate avea maximum 20 MB.': 'A PDF legfeljebb 20 MB méretű lehet.', 'Formularul nu a putut fi adăugat.': 'Az űrlapot nem sikerült hozzáadni.', 'Formularul nu a putut fi înlocuit.': 'Az űrlapot nem sikerült lecserélni.',
  ...
  en: {
    ...
    'Acces securizat': 'Secure access', 'Portalul intern': 'Internal portal', 'Autentificare': 'Sign in', 'Introdu datele contului tău Elmont.': 'Enter your Elmont account details.', 'Parolă': 'Password', 'Intră în portal': 'Enter portal', 'Se conectează...': 'Signing in...', 'Am uitat parola': 'Forgot password', 'Înapoi la site': 'Back to website', 'Ține-mă autentificat pe acest dispozitiv': 'Keep me signed in on this device', 'Deschide camera': 'Open camera', 'Închide camera': 'Close camera', 'Așază cartea de identitate în chenar': 'Place the identity card inside the frame', 'Fotografiază și citește': 'Capture and read',
    'Prezentare': 'Overview', 'Pontaje': 'Attendance', 'Angajați': 'Employees', 'Salarizare': 'Payroll', 'Concedii': 'Leave', 'Rapoarte': 'Reports', 'Oferte': 'Quotes', 'Proiecte': 'Projects', 'Branșamente': 'Connections', 'Formulare': 'Forms', 'Mesaje': 'Messages', 'Chat intern': 'Internal chat', 'Configurare': 'Settings', 'Contabilitate': 'Accounting', 'Cont': 'Account',
    'Documente tipizate': 'Standard documents', 'Formulare și cereri': 'Forms and requests', 'Previzualizare, printare și gestiunea modelelor companiei.': 'Preview, print and manage company templates.', 'Adaugă formular': 'Add form', 'Semnare documente': 'Sign documents', 'Adaugă șablon de semnare': 'Add signing template', 'Deschide editorul': 'Open editor', 'Vizualizează': 'View', 'PDF original': 'Original PDF', 'Cereri': 'Requests', 'Modelele de cereri urmează să fie configurate': 'Request templates will be configured next', 'Pentru fiecare cerere vom stabili ce date se preiau din proiectul sau branșamentul selectat.': 'For each request, we will define which data is imported from the selected project or connection.', 'Printează': 'Print', 'Deschide PDF': 'Open PDF', 'Înlocuiește': 'Replace', 'Încarcă un model PDF tipizat.': 'Upload a standard PDF template.', 'Denumirea formularului': 'Form name', 'Selectează documentul PDF': 'Select PDF document', 'Maximum 20 MB': 'Maximum 20 MB', 'Renunță': 'Cancel', 'Fișierul trebuie să fie PDF.': 'The file must be a PDF.', 'PDF-ul poate avea maximum 20 MB.': 'The PDF can be up to 20 MB.', 'Formularul nu a putut fi adăugat.': 'The form could not be added.', 'Formularul nu a putut fi înlocuit.': 'The form could not be replaced.', 'Pontaj clar, zi de zi.': 'Clear attendance, every day.', 'Vizualizare grilă': 'Grid view', 'Vizualizare listă': 'List view',
