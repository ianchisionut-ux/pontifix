...
const translations: Record<'hu' | 'en', Record<string, string>> = {
  hu: {
    ...
    'Prezentare': 'Áttekintés', 'Pontaje': 'Munkaidő', 'Angajați': 'Alkalmazottak', 'Concedii': 'Szabadságok', 'Rapoarte': 'Jelentések', 'Oferte': 'Ajánlatok', 'Proiecte': 'Projektek', 'Branșamente': 'Csatlakozások', 'Formulare': 'Űrlapok', 'Mesaje': 'Üzenetek', 'Configurare': 'Beállítások', 'Cont': 'Fiók',
  ...
  en: {
    ...
    'Prezentare': 'Overview', 'Pontaje': 'Attendance', 'Angajați': 'Employees', 'Concedii': 'Leave', 'Rapoarte': 'Reports', 'Oferte': 'Quotes', 'Proiecte': 'Projects', 'Branșamente': 'Connections', 'Formulare': 'Forms', 'Mesaje': 'Messages', 'Configurare': 'Settings', 'Cont': 'Account',
