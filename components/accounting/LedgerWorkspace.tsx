...
type SagaPreview = { total:number; duplicates:number; errors:string[]; entries:Array<{date:string;documentNumber:string;description:string;lines:Array<{accountCode:string;debit:number;credit:number}>}> };
