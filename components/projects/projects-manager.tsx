...
type Project = { id:string; name:string; certificateNumber:string|null; certificateDate:string|null; beneficiary:string|null; beneficiaryPhone:string|null; address:string|null; description:string|null; status:ProjectStatus; contractSigned:boolean; constructionAuthorizationStatus:ApprovalStatus; documentUrl:string|null; documentName:string|null; authorizationDocumentUrl:string|null; authorizationDocumentName:string|null; updatedAt:string; approvals:Approval[] }
