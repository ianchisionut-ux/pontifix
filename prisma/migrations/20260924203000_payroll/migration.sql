...
CREATE UNIQUE INDEX IF NOT EXISTS "AttendanceEmployee_businessId_cnp_key"
  ON "AttendanceEmployee" ("businessId", "cnp") WHERE "cnp" IS NOT NULL AND "cnp" <> '';
CREATE INDEX IF NOT EXISTS "AttendanceEmployee_businessId_contractNumber_idx"
  ON "AttendanceEmployee" ("businessId", "contractNumber");
...
CREATE TABLE IF NOT EXISTS "PayrollRun" (
  ...
  "minimumGross" DOUBLE PRECISION NOT NULL,
  "nonTaxableAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "casRate" DOUBLE PRECISION NOT NULL DEFAULT 25,
  "cassRate" DOUBLE PRECISION NOT NULL DEFAULT 10,
  "incomeTaxRate" DOUBLE PRECISION NOT NULL DEFAULT 10,
  "camRate" DOUBLE PRECISION NOT NULL DEFAULT 2.25,
  "notes" TEXT,
